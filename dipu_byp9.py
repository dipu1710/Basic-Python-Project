...
# Sample dataset
data = {
    "Name": ["Morice", "Jenny", "Charlie", "David", "Jenna", "Devid", "Asha", "Hannah"],
    "Math": [85, 70, 90, 70, 75, 95, 80, 65],
    "Science": [88, 65, 85, 75, 80, 92, 78, 60],
    "English": [78, 72, 88, 66, 74, 80, 82, 68],
    "Sports": [90, 85, 70, 50, 95, 80, 75, 65]
}
